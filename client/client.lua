...
Citizen.CreateThread(function()
	while GLRPhabibob == nil do
		TriggerEvent('glrphabibob:getSharedObject', function(obj) GLRPhabibob = obj end)
		Citizen.Wait(0)
	end
end)
		...
		while true do
			...
			if nearBank() or nearATM() then
				...
				if IsControlJustPressed(1, keys[Config.Keys.Open]) then
					if nearBank() or nearATM() then
						openUI()
						TriggerServerEvent('glrpbamboo:bank:balance')
...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('glrpbamboo:bank:deposit', tonumber(data.amount))
	TriggerServerEvent('glrpbamboo:bank:balance')
end)
...
RegisterNUICallback('withdrawl', function(data)
	TriggerServerEvent('glrpbamboo:bank:withdraw', tonumber(data.amountw))
	TriggerServerEvent('glrpbamboo:bank:balance')
end)
...
RegisterNUICallback('transfer', function(data)
	TriggerServerEvent('glrpbamboo:bank:transfer', data.to, data.amountt)
	TriggerServerEvent('glrpbamboo:bank:balance')
end)
